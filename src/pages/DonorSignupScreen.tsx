...
const DonorSignupScreen = () => {
  ...
  const handleCreateAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await Promise.all([
        ...
        supabase
          .from("profiles")
          .update({ full_name: fullName, blood_group: bloodGroup })
  ...
  const handleGetLocation = async () => {
    ...
    try {
      ...
      toast.success("Location saved! Your profile is complete 🎉");
      navigate("/");
    } catch {
      toast.warning("Location skipped. You can enable it later in Settings.");
      navigate("/");
    } finally {
      setLoading(false);
    }
          ...
          >
            <div className="p-4 rounded-2xl bg-primary/5 border border-primary/20 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Donors with verified phones receive emergency blood alerts via SMS and calls.
                </p>
              </div>
            </div>
            ...
            {!phoneVerified ? (
              ...
              <div className="flex flex-col items-center gap-3 py-10">
                ...
                <p className="text-muted-foreground text-sm">Proceeding to location setup…</p>
              </div>
            )}
          ...
          >
            <div className="p-4 rounded-2xl bg-primary/5 border border-primary/20 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Nearby patients find you based on your location. It updates automatically every time you open the app — no action needed.
                </p>
              </div>
            </div>
